...
func (cli *Client) SecretInspect(ctx context.Context, secretID string) (types.Secret, error) {
...
func (cli *Client) SecretInspectWithRaw(ctx context.Context, secretID string) (types.Secret, []byte, error) {
