...
type SecretSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// Type distinguishes the different kinds of secrets in the system.
	Type SecretType `protobuf:"varint,2,opt,name=type,proto3,enum=docker.swarmkit.v1.SecretType" json:"type,omitempty"`
	// Secret payload.
...
func (m *SecretSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.Type != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Type))
	}
	if len(m.Data) > 0 {
		data[i] = 0x1a
		i++
...
=======
	...
	,
>>>>>>> 28a8c93... secrets: update vendor for secrets
}
