...
type Secret struct {
	ID         string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta       Meta                   `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	SecretData map[string]*SecretData `protobuf:"bytes,3,rep,name=secret_data,json=secretData" json:"secret_data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	...
	LatestVersion string `protobuf:"bytes,5,opt,name=latest,proto3" json:"latest,omitempty"`
}
...
type SecretData struct {
	...
	SecretSize int32 `protobuf:"varint,5,opt,name=size,proto3" json:"size,omitempty"`
}

func (m *SecretData) Reset()                    { *m = SecretData{} }
func (*SecretData) ProtoMessage()               {}
func (*SecretData) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{9} }
...
func init() {
	...
	proto.RegisterType((*SecretData)(nil), "docker.swarmkit.v1.SecretData")
}
...
func (m *Secret) Copy() *Secret {
	...
	if m.SecretData != nil {
		o.SecretData = make(map[string]*SecretData)
		for k, v := range m.SecretData {
			o.SecretData[k] = v.Copy()
		}
	}
...
func (m *SecretData) Copy() *SecretData {
	if m == nil {
		return nil
	}
...
func (this *SecretData) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&api.SecretData{")
	s = append(s, "ID: "+fmt.Sprintf("%#v", this.ID)+",\n")
	s = append(s, "Meta: "+strings.Replace(this.Meta.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "Spec: "+strings.Replace(this.Spec.GoString(), `&`, ``, 1)+",\n")
...
func (m *Secret) MarshalTo(data []byte) (int, error) {
	...
	if len(m.SecretData) > 0 {
		for k, _ := range m.SecretData {
			...
			msgSize := v.Size()
			mapSize := 1 + len(k) + sovObjects(uint64(len(k))) + 1 + msgSize + sovObjects(uint64(msgSize))
	...
	if len(m.LatestVersion) > 0 {
		data[i] = 0x2a
		i++
		i = encodeVarintObjects(data, i, uint64(len(m.LatestVersion)))
		i += copy(data[i:], m.LatestVersion)
	}
	return i, nil
}

func (m *SecretData) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *SecretData) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Secret) Size() (n int) {
	...
	if len(m.SecretData) > 0 {
		for k, v := range m.SecretData {
			...
			mapEntrySize := 1 + len(k) + sovObjects(uint64(len(k))) + 1 + l + sovObjects(uint64(l))
...
func (this *SecretData) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SecretData{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
...
func (m *Secret) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			iNdEx = postmsgIndex
			if m.SecretData == nil {
				m.SecretData = make(map[string]*SecretData)
			}
...
func (m *SecretData) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SecretData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SecretData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.SecretSize |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorObjects = []byte{
	...
	,
}
